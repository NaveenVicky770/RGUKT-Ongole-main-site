    ...
    <main>
      <div class="location">
        <p>
          ...
          <a href="index.php">Academic photos</a>
        </p>
      </div>
      <div class="row-width content-box">
        <div class="main-content">
          <div class="hr-line mt-3"></div>
          <h1 class="heading-primary text-center">Department of Civil Conducted Two week workshop on AUTOCAD and Its applications in Civil Engineering</h1>
