   ...
   <div class="location">
    <p>
        ...
        <a href="instituteinfo.php?data=aboutrgukt">About RGUKT</a>
    </p>
</div>
            ...
            <ul class="side-navigation-list side-navigation">
                <li class="side-navigation-items">
                    <a href="instituteinfo.php?data=aboutrgukt" class="side-navigation-links active-item">
                        About Rgukt <i class="fa fa-long-arrow-right ml-2" aria-hidden="true"></i>
                    </a>
                </li>
                <li class="side-navigation-items">
                    <a href="#founding" class="side-navigation-links">Founding of RGUKT</a>
                </li>
                <li class="side-navigation-items">
                    <a href="#edu-obj" class="side-navigation-links">RGUKT Educational Objectives</a>
                </li>
                <li class="side-navigation-items">
                    <a href="#uni-obj" class="side-navigation-links">Objectives of the University</a>
                </li>
                <li class="side-navigation-items">
                    <a href="#why" class="side-navigation-links">Why RGUKT ?</a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-md-10 col-lg-10 col-xl-10">
            <div class="main-content  pl-3">
                <div class="rgukt-content">
                    <h1 class="heading-primary" id="founding">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>Founding of RGUKT
                    </h1>
                    ...
                    <h1 class="heading-primary" id="edu-obj">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>RGUKT Educational Objectives
                    </h1>
                    ...
                    <h1 class="heading-primary" id="uni-obj">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>Objectives of the University
                    </h1>
                    ...
                    <h1 class="heading-primary" id="why">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>Why RGUKT ?
                    </h1>
                    ...
                    <ul>
                        ...
                        <li>The time on task devoted to study the material</li>
                    </ul>
                    <p>
