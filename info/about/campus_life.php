<div class="location">
    <p>
        ...
        <a href="instituteinfo.php?data=campuslife">Campus Life</a>
    </p>
</div>
            ...
            <ul class="side-navigation-list side-navigation">
                <li class="side-navigation-items">
                    <a href="instituteinfo.php?data=aboutrgukt" class="side-navigation-links active-item">
                        Campus Life<i class="fa fa-long-arrow-right ml-2" aria-hidden="true"></i>
                    </a>
                </li>
                <li class="side-navigation-items">
                    <a href="#lifeatrgukt" class="side-navigation-links">Life at RGUKT</a>
                </li>
                <li class="side-navigation-items">
                    <a href="#sports" class="side-navigation-links">Sports</a>
                </li>
                <li class="side-navigation-items">
                    <a href="#shopping" class="side-navigation-links">Shopping center</a>
                </li>
                <li class="side-navigation-items">
                    <a href="#extra-activities" class="side-navigation-links">Extra curricular activities</a>
                </li>
                <li class="side-navigation-items">
                    <a href="#soft-skills" class="side-navigation-links">Soft Skills</a>
                </li>
                <li class="side-navigation-items">
                    <a href="#healthy" class="side-navigation-links">Health and saftey</a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-md-10 col-lg-10 col-xl-10">
            <div class="main-content  pl-3">
                <div class="rgukt-content">
                    <h1 class="heading-primary text-center">Campus Life at the RGUKT</h1>
                    <h3 class="heading-secondary" id="lifeatrgukt">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>Life at rgukt
                    </h3>
                    <p>
                    ...
                    <h3 class="heading-secondary" id="sports">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>Sports and Games
                    </h3>
                    ...
                    <h3 class="heading-secondary" id="shopping">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>Shopping Center
                    </h3>
                    <p>
                    ...
                    <h3 class="heading-secondary" id="extra-activities">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>Extra-curricular activities in RGUKT
                    </h3>
                    <p>
                    ...
                    <h3 class="heading-secondary" id="soft-skills">
                        <i class="fa fa-hand-o-right mr-3" aria-hidden="true"></i>Soft skills and Edutainment
                    </h3>
                    <p>
