<div>
    <div class="row">
        <div class="col-2 announce-tag d-none d-sm-block" >
                <div class="arrow-right" style="margin-right:10px;"><p>Announcements</p></div>
        </div>
        <div class="col-9 announcement">
            <span>
                ...
                <div class="text-marquee">
                    <span>
                        ...
                        <marquee behavior="scroll" direction="left" scrollamount="10" onmouseover="this.stop();" onmouseout="this.start();">
                            <a href="http://www.rgukt.in/R-RGUKTCET" target="_blank"> Circular to the Students and Staff 09-04-2021 <img src="images/new.gif"></a>
